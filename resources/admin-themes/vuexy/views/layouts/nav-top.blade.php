            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"> {{ auth()->guard('admin')->user()->name }}</span><span class="user-status">{{ auth()->guard('admin')->user()->role['name'] }}</span></div><span><img class="round" src="{{ asset('vendor/webkul/admin/app-assets/images/portrait/small/avatar-s-11.jpg')}}" alt="avatar" height="40" width="40"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('shop.home.index') }}" target="_blank"> {{ trans('admin::app.layouts.visit-shop') }}</a><a class="dropdown-item" href="{{ route('admin.account.edit') }}">{{ trans('admin::app.layouts.my-account') }}</a>
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('admin.session.destroy') }}"><i class="feather icon-power"></i> {{ trans('admin::app.layouts.logout') }}</a>
                        </div>
                    </li>
                </ul>
            </div>
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="mr-50"><img src="{{ asset('vendor/webkul/admin/app-assets/images/icons/xls.png')}}" alt="png" height="32"></div>
